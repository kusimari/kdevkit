...
assert_file_contains "$FS" "Requirements:"             "feature-setup includes Requirements"
assert_file_contains "$FS" "Design:"                   "feature-setup includes Design"
assert_file_contains "$FS" "Testing:"                  "feature-setup includes Testing"
assert_file_contains "$FS" "Implementation:"           "feature-setup includes Implementation"
...
assert_file_contains "$FS" "Requirements,"             "template includes Requirements Specification"
assert_file_contains "$FS" "Design,"                   "template includes Technical Design section"
...
echo ""
echo "--- dev-mode: build/feature-setup.md (companion) has compacted interview content ---"

FS_BUILD="$REPO/build/feature-setup.md"
assert_file_contains "$FS_BUILD" "Requirements:"    "build feature-setup includes Requirements"
assert_file_contains "$FS_BUILD" "Design:"          "build feature-setup includes Design"
assert_file_contains "$FS_BUILD" "Testing:"         "build feature-setup includes Testing"
assert_file_contains "$FS_BUILD" "Implementation:"  "build feature-setup includes Implementation"
